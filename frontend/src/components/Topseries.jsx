...
const Topseries = () => {
  ...
  return (
    <div className='relative my-8 mx-4'>
      ...
      <button onClick={handlePrev} className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full p-3 backdrop-blur-md">
        <ChevronLeft size={28} />
      </button>
      {Series && 
